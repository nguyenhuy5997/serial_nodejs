...
function decodeSentence(stub, fields) {
    return __assign(__assign({}, PacketStub_1.initStubFields(stub, exports.sentenceId, exports.sentenceName)), { time: helpers_1.parseTime(fields[1]), totalRms: helpers_1.parseFloatSafe(fields[2]), semiMajorError: helpers_1.parseFloatSafe(fields[3]), semiMinorError: helpers_1.parseFloatSafe(fields[4]), orientationOfSemiMajorError: helpers_1.parseFloatSafe(fields[5]), latitudeError: helpers_1.parseFloatSafe(fields[6]), longitudeError: helpers_1.parseFloatSafe(fields[7]), altitudeError: helpers_1.parseFloatSafe(fields[8]) });
}
