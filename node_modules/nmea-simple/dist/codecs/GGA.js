...
function decodeSentence(stub, fields) {
    return __assign(__assign({}, PacketStub_1.initStubFields(stub, exports.sentenceId, exports.sentenceName)), { time: helpers_1.parseTime(fields[1]), latitude: helpers_1.parseLatitude(fields[2], fields[3]), longitude: helpers_1.parseLongitude(fields[4], fields[5]), fixType: FixTypes[helpers_1.parseIntSafe(fields[6])], satellitesInView: helpers_1.parseIntSafe(fields[7]), horizontalDilution: helpers_1.parseFloatSafe(fields[8]), altitudeMeters: helpers_1.parseFloatSafe(fields[9]), geoidalSeperation: helpers_1.parseFloatSafe(fields[11]), differentialAge: helpers_1.parseFloatSafe(fields[13]), differentialRefStn: fields[14] });
}
