 ...
 */
function appendChecksumFooter(sentenceWithoutChecksum) {
    return sentenceWithoutChecksum + createNmeaChecksumFooter(sentenceWithoutChecksum);
}
exports.appendChecksumFooter = appendChecksumFooter;
// =========================================
// field encoders
// =========================================
 ...
 */
function parseDmCoordinate(coordinate) {
    var dotIdx = coordinate.indexOf(".");
    if (dotIdx < 0) {
        return 0;
    }
    var degrees;
...
exports.parseDmCoordinate = parseDmCoordinate;
/**
